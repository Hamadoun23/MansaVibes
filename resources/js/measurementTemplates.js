export default function registerMeasurementTemplates(Alpine) {
  Alpine.data('measurementTemplateBuilder', (initialRows = []) => ({
    uidSeq: 0,
    rows: [],
    init() {
  ...
  Alpine.data('measurementTemplateCreateForm', (opts = {}) => ({
    uidSeq: 0,
    rows: [],
    ...
    formRefPrice: Number(opts.formRefPrice ?? 0) || 0,
    ...
    onCopyFromChange() {
      ...
      this.formRefPrice = Number(t.reference_price_fcfa) || 0;
